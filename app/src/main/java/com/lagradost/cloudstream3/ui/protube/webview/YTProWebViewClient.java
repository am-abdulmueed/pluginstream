...
public class YTProWebViewClient extends WebViewClient {
	...
	public YTProWebViewClient(ProTubeFragment fragment, YTProWebView web) {
	...
	public void onPageFinished(WebView view, String url) {
		...
		if (!url.contains("youtube.com/watch") && !url.contains("youtube.com/shorts") && fragment.isPlaying) {
			fragment.isPlaying = false;
			fragment.mediaSession = false;
